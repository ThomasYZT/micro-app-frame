  ...
  <div class="page-container">
    <div class="page-content">
      <div class="header">
        ...
        <img class="banner" src="https://weapppiccdn.yishihui.com/h5icon/activity/pc_201124_banner.png" alt="">
      </div>
      ...
      <div class="info-box">
        ...
        <div class="info-box-content">
          <div class="text-block" style="padding: 0 34px;">
            票圈视频全新功能震撼上线，微信文章一键转视频！选择与你观点的契合的文章，进行视频化创作吧！
          </div>

          <div class="img-block">
            <img src="https://weapppiccdn.yishihui.com/h5icon/activity/pc_201124_hdjl.png" alt="">
          </div>
          <div class="img-block">
            <img src="https://weapppiccdn.yishihui.com/h5icon/activity/pc_201124_hdsj.png" alt="">
          </div>
          <div class="img-block">
            <img src="https://weapppiccdn.yishihui.com/h5icon/activity/pc_201124_pxgz.png" alt="">
          </div>
          <div class="img-block">
            <img class="code-img" src="https://weapppiccdn.yishihui.com/h5icon/activity/pc_201124_ewm.png" alt="">
          </div>
        </div>
      </div>
    </div>
