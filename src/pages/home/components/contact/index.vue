<template>
  <div class="contact">
    <div class="bg">
      <img src="../../../../assets/img/pic_six_bj.jpg" alt="">
      <div class="mask"></div>
    </div>
    ...
    <div class="block-wrapper">
      <div class="block-content">
        ...
        <div class="desc wow"  data-animate="fadeInUp">
          <div class="info-row">
            <div class="info-item">
              <img v-lazy="imgSrc.icon1" src="" alt="">
              电话：0731 - 85679198
            </div>
            <div class="info-item">
              <img v-lazy="imgSrc.icon2" src="" alt="">
              手机：18974809627
            </div>
          </div>
          <div class="info-row">
            <div class="info-item">
              <img v-lazy="imgSrc.icon3" src="" alt="">
              地址：北京市海淀区西北旺东路10号院东区4号楼2层222室
            </div>
          </div>
          <div class="info-row">
            <div class="code-box">
              <img src="../../../../assets/img/pic_six_service@2x.png" alt="">
              <span>客服微信</span>
            </div>
            <div class="code-box">
              <img src="../../../../assets/img/pic_six_vlog@2x.png" alt="">
              <span>票圈Vlog精选公众号</span>
            </div>
            <div class="code-box">
              <img src="../../../../assets/img/pic_six_jsb@2x.png" alt="">
              <span>票圈极速版公众号</span>
            </div>
          </div>
        </div>
    ...
    <div class="copryright-block">
      ...
      <p>| <span class="link" @click="open('service')">用户服务协议</span> | <span class="link" @click="open('agreement')">隐私政策</span> | <span class="link" @click="go('/pc/help')">帮助中心</span> | 客服及举报: 0731-85679198  |  举报邮箱：dengfeng@piaoquantv.com</p>
...
export default {
  ...
  methods: {
    ...
    open (type) {
      switch (type) {
        case 'service':
          window.open('https://rescdn.yishihui.com/agreement/piaoquantvservice.html');
          break;
        case 'agreement':
